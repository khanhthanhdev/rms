	...
	<div class="mx-auto max-w-6xl px-4 py-24 sm:py-36">
		<div class="mx-auto flex min-h-[40vh] items-center justify-center">
			<div class="max-w-3xl text-center">
				...
				Auth, dashboard, settings, and a modern UI — wired up with Convex, Better Auth,
				and shadcn-svelte. Focus on your product, not the plumbing.
				</p>
				...
				<Accordion.Root type="multiple" class="w-full">
					<Accordion.Item value="item-1">
						...
						<Accordion.Content>
							...
							a responsive dashboard with charts and data tables, user settings pages, and a modern
							UI built with shadcn-svelte and Tailwind CSS v4. Everything is fully typed with TypeScript.
						</Accordion.Content>
					</Accordion.Item>
					...
					<Accordion.Item value="item-7">
						...
						<Accordion.Content>
							...
							5 runes, Convex patterns, Better Auth setup, and Tailwind v4. There's also
